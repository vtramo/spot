...
namespace spot
{
  ...
  public:
    ...
    const scc_info_ptr get_sccinfo() const
    {
      return sccinfo_;
    }
    ...
    bool is_useful_state(unsigned st) const
    {
      ...
      return sccinfo_->reachable_state(st)
             && is_useful_scc(sccinfo_->scc_of(st));
    }
  ...
  SPOT_API bool are_equivalent(std::shared_ptr<scc_infocube> sccinfocube,
