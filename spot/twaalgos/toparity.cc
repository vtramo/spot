...
// TAR is a particular case
  ...
  private:
    ...
    enum algorithm
    {
      ...
      TAR = 16,
      RABIN_TO_BUCHI = 32,
      STREETT_TO_COBUCHI = 64,
      PARITY_TYPE = 128,
      BUCHI_TYPE = 256,
      CO_BUCHI_TYPE = 512,
      PARITY_EQUIV = 1024,
      PARITY_PREFIX = 2048,
      PARITY_PREFIX_GENERAL = 4096,
      GENERIC_EMPTINESS = 8192,
      NONE = 16384
    };
    ...
    apply_copy_edge_index(const const_twa_graph_ptr &sub_aut,
                          ...
                          const algorithm &algo)
    {
      auto col_fun = [&](const twa_graph::edge_storage_t &edge) constexpr
      {
    ...
    try_rabin_to_buchi(twa_graph_ptr &sub_aut)
    {
      ...
      if (buch_aut != nullptr)
      {
        ...
        std::transform(
            ...
            [&](const twa_graph::edge_storage_t &e) constexpr {
