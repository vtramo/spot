...
namespace spot::forq
{
  namespace detail
  {
    ...
    static void calculate_number_of_symbols_in_bdd_handler(
      [[maybe_unused]] char* varset, [[maybe_unused]] int size)
    {
      ++bdd_size;
    }
  ...
  size_t symbol_set::size() const
  {
    return detail::calculate_number_of_symbols_in_bdd(symbols);
  }
