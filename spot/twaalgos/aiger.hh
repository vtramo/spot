...
namespace spot
{
  ...
  /// \param all_outputs Conjunction of all outputs; If set to bdd_false, the
  ///                     named property "synthesis-outputs" is used
  /// \Note: All AP NOT  appearing in outs are considered ins
  SPOT_API void
  restore_form(const twa_graph_ptr& aut, bdd all_outputs = bddfalse);
}
