...
letter-based alphabet, and supported by tools like [[https://github.com/Mazzocchi/FORKLIFT][FORKLIFT]], [[https://languageinclusion.org/doku.php?id=tools][RABIT]], [[http://goal.im.ntu.edu.tw/wiki/doku.php][Goal]] or [[https://iscasmc.ios.ac.cn/roll/doku.php?id=start][ROLL]].  It
looks as follows:
...
formulas over a set of atomtic propositions), hence Spot has no support 
